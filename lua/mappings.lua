...
-- Add size at the top
vim.keymap.set("n", "<C-k>", "<cmd>resize +2<CR>", { desc = "General | Add size at the top", noremap = true, silent = true })

-- Add size at the bottom
vim.keymap.set("n", "<C-j>", "<cmd>resize -2<CR>", { desc = "General | Add size at the bottom", silent = true, noremap = true })
